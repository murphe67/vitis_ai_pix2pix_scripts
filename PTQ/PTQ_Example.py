"""
This is the original example tutorial I adapted, from https://github.com/Xilinx/Vitis-AI-Tutorials/tree/1.4/Design_Tutorials/09-mnist_pyt/files
for Vitis AI 1.4

The tutorial is very good and I would reccommend following it, but have just attached the PQT bit here.
"""
